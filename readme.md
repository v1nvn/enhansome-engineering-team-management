...
* [Paper we love: Software Engineering Organizations](https://github.com/papers-we-love/papers-we-love/tree/master/software_engineering_orgs) ⭐ 106,214 | 🐛 3 | 🌐 Shell | 📅 2026-05-07 - “The practice of software engineering, and its history is, itself, a complex study in humanity, coordination, and communication.”
...
* [Engineering Manager Resources](https://github.com/ryanburgess/engineer-manager) ⭐ 10,704 | 🐛 5 | 🌐 JavaScript | 📅 2026-03-02 - Huge list, but need some curation.
...
* [Hiring Without Whiteboards](https://github.com/poteto/hiring-without-whiteboards) ⭐ 50,611 | 🐛 38 | 🌐 JavaScript | 📅 2026-02-27 - List of companies without the kind of CS trivia questions that are associated with bad interview practices.

* [Awesome Job Boards](https://github.com/tramcar/awesome-job-boards) ⭐ 1,732 | 🐛 11 | 📅 2026-04-20 - Niche job boards by domains, technology, roles and area.
...
* [Reverse interview](https://github.com/viraptor/reverse-interview) ⭐ 28,536 | 🐛 23 | 📅 2025-02-19 - Questions to ask the company during your interview. Be prepared to answer them as a manager.

* [Back-End Developer Interview Questions](https://github.com/arialdomartini/Back-End-Developer-Interview-Questions) ⭐ 16,653 | 🐛 16 | 📅 2024-11-15 - A great source of inspiration.
...
* [FizzBuzz Enterprise Edition](https://github.com/EnterpriseQualityCoding/FizzBuzzEnterpriseEdition) ⭐ 23,657 | 🐛 545 | 🌐 Java | 📅 2024-07-15 - A satire of over-engineering for the sake of enterprise-grade software.
...
* [hacker-laws](https://github.com/dwmkerr/hacker-laws) ⭐ 27,136 | 🐛 148 | 🌐 HTML | 📅 2026-02-06 - Laws, Theories, Principles and Patterns that developers will find useful.
...
* [Awesome Concepts](https://github.com/lukasz-madon/awesome-concepts) ⭐ 615 | 🐛 3 | 📅 2024-03-04 - Laws, principles, mental models and cognitive biases.
...
* [The Efficiency-Destroying Magic of Tidying Up](https://flocrivello.com/the-efficiency-destroying-magic-of-tidying-up/) - “Efficiency tends to look messy, and good looks tend to be inefficient.” A reminder that sometimes we should just accept [the messiness of the world](https://github.com/kdeldycke/awesome-falsehood) ⭐ 27,354 | 🐛 3 | 📅 2026-04-27.
...
* [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 45,768 | 🐛 16 | 📅 2026-05-08 - Resources on working remotely, including job boards, coworking spaces, and a list of companies embracing the culture.
...
* [How to exit vim, the Product Manager way](https://github.com/hakluke/how-to-exit-vim/blob/master/README.md#the-product-manager-way) ⭐ 7,191 | 🐛 102 | 📅 2026-03-14 - A satire with a grain of truth, especially the comparison between the basic vs experienced level.

* [Open Product Management](https://github.com/tron1991/open-product-management) ⭐ 4,333 | 🐛 14 | 📅 2024-07-01 - Resources, interviews, case studies, sample products & projects, communities, open source tools, free & paid services on product management, for technical people to learn the field.

* [Awesome Product Management](https://github.com/dend/awesome-product-management) ⭐ 2,148 | 🐛 88 | 🌐 CSS | 📅 2026-02-08 - A reference. All the missing pieces are found below.
...
* [Awesome OKR](https://github.com/domenicosolazzo/awesome-okr) ⭐ 1,769 | 🐛 3 | 📅 2022-08-10 - There is no shortage of content on how to measure and communicate objectives.
...
The [header image](https://github.com/kdeldycke/awesome-engineering-team-management/blob/main/assets/awesome-management-header.png) ⭐ 2,462 | 🐛 3 | 📅 2026-04-27 is based on a modified [photo taken in November 2017](https://unsplash.com/photos/6dDHofabCQ8) by [Werner Du plessis](https://unsplash.com/@werner01).
