...
* [Paper we love: Software Engineering Organizations](https://github.com/papers-we-love/papers-we-love/tree/master/software_engineering_orgs) ⭐ 103,051 | 🐛 3 | 🌐 Shell | 📅 2025-10-10 - “The practice of software engineering, and its history is, itself, a complex study in humanity, coordination, and communication.”
...
* [Engineering Manager Resources](https://github.com/ryanburgess/engineer-manager) ⭐ 10,687 | 🐛 4 | 🌐 JavaScript | 📅 2025-12-04 - Huge list, but need some curation.
...
* [Hiring Without Whiteboards](https://github.com/poteto/hiring-without-whiteboards) ⭐ 50,413 | 🐛 31 | 🌐 JavaScript | 📅 2026-01-26 - List of companies without the kind of CS trivia questions that are associated with bad interview practices.

* [Awesome Job Boards](https://github.com/tramcar/awesome-job-boards) ⭐ 1,585 | 🐛 4 | 📅 2025-09-26 - Niche job boards by domains, technology, roles and area.
...
* [Reverse interview](https://github.com/viraptor/reverse-interview) ⭐ 28,492 | 🐛 23 | 📅 2025-02-19 - Questions to ask the company during your interview. Be prepared to answer them as a manager.

* [Back-End Developer Interview Questions](https://github.com/arialdomartini/Back-End-Developer-Interview-Questions) ⭐ 16,552 | 🐛 16 | 📅 2024-11-15 - A great source of inspiration.

* [Engineering Leadership Interviews](https://github.com/kaushikb9/em-interviews) ⭐ 247 | 🐛 0 | 📅 2021-06-27 - An outline on how to recruit for engineering manager roles.
...
* [FizzBuzz Enterprise Edition](https://github.com/EnterpriseQualityCoding/FizzBuzzEnterpriseEdition) ⭐ 23,187 | 🐛 538 | 🌐 Java | 📅 2024-07-15 - A satire of over-engineering for the sake of enterprise-grade software.
...
* [hacker-laws](https://github.com/dwmkerr/hacker-laws) ⭐ 26,998 | 🐛 149 | 🌐 HTML | 📅 2026-02-06 - Laws, Theories, Principles and Patterns that developers will find useful.
...
* [Awesome Concepts](https://github.com/lukasz-madon/awesome-concepts) ⭐ 520 | 🐛 1 | 📅 2024-03-04 - Laws, principles, mental models and cognitive biases.
...
* [The Efficiency-Destroying Magic of Tidying Up](https://flocrivello.com/the-efficiency-destroying-magic-of-tidying-up/) - “Efficiency tends to look messy, and good looks tend to be inefficient.” A reminder that sometimes we should just accept [the messiness of the world](https://github.com/kdeldycke/awesome-falsehood) ⭐ 27,009 | 🐛 7 | 📅 2026-01-20.
...
* [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 43,378 | 🐛 20 | 📅 2026-01-12 - Resources on working remotely, including job boards, coworking spaces, and a list of companies embracing the culture.
...
* [How to exit vim, the Product Manager way](https://github.com/hakluke/how-to-exit-vim/blob/master/README.md#the-product-manager-way) ⭐ 7,157 | 🐛 101 | 📅 2024-06-13 - A satire with a grain of truth, especially the comparison between the basic vs experienced level.

* [Open Product Management](https://github.com/tron1991/open-product-management) ⭐ 4,178 | 🐛 14 | 📅 2024-07-01 - Resources, interviews, case studies, sample products & projects, communities, open source tools, free & paid services on product management, for technical people to learn the field.

* [Awesome Product Management](https://github.com/dend/awesome-product-management) ⭐ 1,968 | 🐛 78 | 🌐 CSS | 📅 2025-11-22 - A reference. All the missing pieces are found below.
...
* [Awesome OKR](https://github.com/domenicosolazzo/awesome-okr) ⭐ 1,745 | 🐛 3 | 📅 2022-08-10 - There is no shortage of content on how to measure and communicate objectives.
...
The [header image](https://github.com/kdeldycke/awesome-engineering-team-management/blob/main/assets/awesome-management-header.png) ⭐ 2,391 | 🐛 6 | 📅 2026-01-20 is based on a modified [photo taken in November 2017](https://unsplash.com/photos/6dDHofabCQ8) by [Werner Du plessis](https://unsplash.com/@werner01).
