...
* [Paper we love: Software Engineering Organizations](https://github.com/papers-we-love/papers-we-love/tree/master/software_engineering_orgs) ⭐ 106,446 | 🐛 2 | 🌐 Shell | 📅 2026-05-17 - “The practice of software engineering, and its history is, itself, a complex study in humanity, coordination, and communication.”
...
* [Hiring Without Whiteboards](https://github.com/poteto/hiring-without-whiteboards) ⭐ 50,635 | 🐛 38 | 🌐 JavaScript | 📅 2026-02-27 - List of companies without the kind of CS trivia questions that are associated with bad interview practices.

* [Awesome Job Boards](https://github.com/tramcar/awesome-job-boards) ⭐ 1,733 | 🐛 13 | 📅 2026-04-20 - Niche job boards by domains, technology, roles and area.
...
* [Back-End Developer Interview Questions](https://github.com/arialdomartini/Back-End-Developer-Interview-Questions) ⭐ 16,662 | 🐛 16 | 📅 2024-11-15 - A great source of inspiration.
...
* [FizzBuzz Enterprise Edition](https://github.com/EnterpriseQualityCoding/FizzBuzzEnterpriseEdition) ⭐ 23,660 | 🐛 545 | 🌐 Java | 📅 2024-07-15 - A satire of over-engineering for the sake of enterprise-grade software.
...
* [hacker-laws](https://github.com/dwmkerr/hacker-laws) ⭐ 27,145 | 🐛 147 | 🌐 HTML | 📅 2026-05-19 - Laws, Theories, Principles and Patterns that developers will find useful.
...
* [The Efficiency-Destroying Magic of Tidying Up](https://flocrivello.com/the-efficiency-destroying-magic-of-tidying-up/) - “Efficiency tends to look messy, and good looks tend to be inefficient.” A reminder that sometimes we should just accept [the messiness of the world](https://github.com/kdeldycke/awesome-falsehood) ⭐ 27,371 | 🐛 3 | 📅 2026-04-27.
...
* [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 45,886 | 🐛 22 | 📅 2026-05-08 - Resources on working remotely, including job boards, coworking spaces, and a list of companies embracing the culture.
...
* [Awesome Product Management](https://github.com/dend/awesome-product-management) ⭐ 2,164 | 🐛 96 | 🌐 CSS | 📅 2026-02-08 - A reference. All the missing pieces are found below.
...
The [header image](https://github.com/kdeldycke/awesome-engineering-team-management/blob/main/assets/awesome-management-header.png) ⭐ 2,493 | 🐛 3 | 📅 2026-04-27 is based on a modified [photo taken in November 2017](https://unsplash.com/photos/6dDHofabCQ8) by [Werner Du plessis](https://unsplash.com/@werner01).
