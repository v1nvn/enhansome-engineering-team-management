...
* [Paper we love: Software Engineering Organizations](https://github.com/papers-we-love/papers-we-love/tree/master/software_engineering_orgs) ⭐ 104,483 | 🐛 3 | 🌐 Shell | 📅 2026-02-22 - “The practice of software engineering, and its history is, itself, a complex study in humanity, coordination, and communication.”
...
* [Hiring Without Whiteboards](https://github.com/poteto/hiring-without-whiteboards) ⭐ 50,522 | 🐛 38 | 🌐 JavaScript | 📅 2026-02-27 - List of companies without the kind of CS trivia questions that are associated with bad interview practices.
...
* [FizzBuzz Enterprise Edition](https://github.com/EnterpriseQualityCoding/FizzBuzzEnterpriseEdition) ⭐ 23,568 | 🐛 544 | 🌐 Java | 📅 2024-07-15 - A satire of over-engineering for the sake of enterprise-grade software.
...
* [hacker-laws](https://github.com/dwmkerr/hacker-laws) ⭐ 27,027 | 🐛 149 | 🌐 HTML | 📅 2026-02-06 - Laws, Theories, Principles and Patterns that developers will find useful.
...
* [The Efficiency-Destroying Magic of Tidying Up](https://flocrivello.com/the-efficiency-destroying-magic-of-tidying-up/) - “Efficiency tends to look messy, and good looks tend to be inefficient.” A reminder that sometimes we should just accept [the messiness of the world](https://github.com/kdeldycke/awesome-falsehood) ⭐ 27,205 | 🐛 7 | 📅 2026-01-20.
...
* [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 44,254 | 🐛 45 | 📅 2026-01-12 - Resources on working remotely, including job boards, coworking spaces, and a list of companies embracing the culture.
...
* [How to exit vim, the Product Manager way](https://github.com/hakluke/how-to-exit-vim/blob/master/README.md#the-product-manager-way) ⭐ 7,185 | 🐛 101 | 📅 2026-03-14 - A satire with a grain of truth, especially the comparison between the basic vs experienced level.
...
* [Awesome Product Management](https://github.com/dend/awesome-product-management) ⭐ 2,049 | 🐛 36 | 🌐 CSS | 📅 2026-02-08 - A reference. All the missing pieces are found below.
