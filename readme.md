...
* [Paper we love: Software Engineering Organizations](https://github.com/papers-we-love/papers-we-love/tree/master/software_engineering_orgs) ⭐ 105,347 | 🐛 2 | 🌐 Shell | 📅 2026-03-26 - “The practice of software engineering, and its history is, itself, a complex study in humanity, coordination, and communication.”
...
* [Awesome Job Boards](https://github.com/tramcar/awesome-job-boards) ⭐ 1,698 | 🐛 5 | 📅 2026-04-17 - Niche job boards by domains, technology, roles and area.
...
* [hacker-laws](https://github.com/dwmkerr/hacker-laws) ⭐ 27,048 | 🐛 148 | 🌐 HTML | 📅 2026-02-06 - Laws, Theories, Principles and Patterns that developers will find useful.
...
* [The Efficiency-Destroying Magic of Tidying Up](https://flocrivello.com/the-efficiency-destroying-magic-of-tidying-up/) - “Efficiency tends to look messy, and good looks tend to be inefficient.” A reminder that sometimes we should just accept [the messiness of the world](https://github.com/kdeldycke/awesome-falsehood) ⭐ 27,297 | 🐛 1 | 📅 2026-04-13.
...
* [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 45,212 | 🐛 51 | 📅 2026-01-12 - Resources on working remotely, including job boards, coworking spaces, and a list of companies embracing the culture.
...
* [Open Product Management](https://github.com/tron1991/open-product-management) ⭐ 4,283 | 🐛 14 | 📅 2024-07-01 - Resources, interviews, case studies, sample products & projects, communities, open source tools, free & paid services on product management, for technical people to learn the field.

* [Awesome Product Management](https://github.com/dend/awesome-product-management) ⭐ 2,102 | 🐛 61 | 🌐 CSS | 📅 2026-02-08 - A reference. All the missing pieces are found below.
...
The [header image](https://github.com/kdeldycke/awesome-engineering-team-management/blob/main/assets/awesome-management-header.png) ⭐ 2,434 | 🐛 0 | 📅 2026-04-13 is based on a modified [photo taken in November 2017](https://unsplash.com/photos/6dDHofabCQ8) by [Werner Du plessis](https://unsplash.com/@werner01).
