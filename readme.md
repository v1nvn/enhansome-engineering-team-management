...
* [Paper we love: Software Engineering Organizations](https://github.com/papers-we-love/papers-we-love/tree/master/software_engineering_orgs) ⭐ 105,082 | 🐛 2 | 🌐 Shell | 📅 2026-03-26 - “The practice of software engineering, and its history is, itself, a complex study in humanity, coordination, and communication.”
...
* [Hiring Without Whiteboards](https://github.com/poteto/hiring-without-whiteboards) ⭐ 50,536 | 🐛 38 | 🌐 JavaScript | 📅 2026-02-27 - List of companies without the kind of CS trivia questions that are associated with bad interview practices.

* [Awesome Job Boards](https://github.com/tramcar/awesome-job-boards) ⭐ 1,693 | 🐛 16 | 📅 2025-09-26 - Niche job boards by domains, technology, roles and area.
...
* [Reverse interview](https://github.com/viraptor/reverse-interview) ⭐ 28,516 | 🐛 23 | 📅 2025-02-19 - Questions to ask the company during your interview. Be prepared to answer them as a manager.
...
* [hacker-laws](https://github.com/dwmkerr/hacker-laws) ⭐ 27,039 | 🐛 148 | 🌐 HTML | 📅 2026-02-06 - Laws, Theories, Principles and Patterns that developers will find useful.
...
* [Awesome Concepts](https://github.com/lukasz-madon/awesome-concepts) ⭐ 607 | 🐛 3 | 📅 2024-03-04 - Laws, principles, mental models and cognitive biases.
...
* [The Efficiency-Destroying Magic of Tidying Up](https://flocrivello.com/the-efficiency-destroying-magic-of-tidying-up/) - “Efficiency tends to look messy, and good looks tend to be inefficient.” A reminder that sometimes we should just accept [the messiness of the world](https://github.com/kdeldycke/awesome-falsehood) ⭐ 27,268 | 🐛 7 | 📅 2026-01-20.
...
* [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 45,002 | 🐛 48 | 📅 2026-01-12 - Resources on working remotely, including job boards, coworking spaces, and a list of companies embracing the culture.
...
* [Awesome Product Management](https://github.com/dend/awesome-product-management) ⭐ 2,078 | 🐛 52 | 🌐 CSS | 📅 2026-02-08 - A reference. All the missing pieces are found below.
